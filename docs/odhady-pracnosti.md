...
Pozn.: Petra byla na dovolené 26. 3. – 5. 4. (6 pracovních dní). Tomáš byl v projektu od 10. 3. (Sprint 2), první 3 dny onboarding.
...
|-----------|-----------|------------|-------------|
| Integrace Salesforce CRM | 20 | 280 000 | Odhad odeslán klientovi 8. 4. |
